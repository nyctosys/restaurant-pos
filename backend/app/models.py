...
class Sale(db.Model):
    ...
    kitchen_status = db.Column(db.String(20), nullable=True, default='placed')  # placed, accepted, preparing, ready, served
    modifications = db.Column(db.JSON, nullable=True, default=[])  # array of modification events: [{"type", "description", "timestamp", "product_title"}]
