...
INGREDIENTS_SEED: list[tuple[str, str, UnitOfMeasure, str, float, float, int | None]] = [
    ("Chicken Boneless", "ING-CHK-01", UnitOfMeasure.KG, "Protein", 26.0, 6.0, 3),
    ("Chicken Wings", "ING-CHK-02", UnitOfMeasure.KG, "Protein", 18.0, 5.0, 3),
    ("Ground Beef", "ING-BEF-01", UnitOfMeasure.KG, "Protein", 16.0, 4.0, 3),
    ("Mozzarella Cheese", "ING-DAI-01", UnitOfMeasure.KG, "Dairy", 14.0, 4.0, 2),
    ("Mayonnaise", "ING-SAU-01", UnitOfMeasure.KG, "Sauce Base", 9.0, 2.0, 1),
    ("Tomato Paste", "ING-SAU-02", UnitOfMeasure.KG, "Sauce Base", 11.0, 3.0, 1),
    ("Soy Sauce", "ING-SAU-03", UnitOfMeasure.L, "Sauce Base", 8.0, 2.0, 1),
    ("Vinegar", "ING-SAU-04", UnitOfMeasure.L, "Sauce Base", 8.0, 2.0, 1),
    ("Garlic Paste", "ING-SPC-01", UnitOfMeasure.KG, "Spices", 6.0, 1.5, 1),
    ("Red Chilli Flakes", "ING-SPC-02", UnitOfMeasure.KG, "Spices", 3.5, 0.8, 1),
    ("Garam Masala", "ING-SPC-03", UnitOfMeasure.KG, "Spices", 3.5, 0.8, 1),
    ("Black Pepper", "ING-SPC-04", UnitOfMeasure.KG, "Spices", 2.5, 0.6, 1),
    ("Fresh Lettuce", "ING-PRD-01", UnitOfMeasure.KG, "Produce", 10.0, 3.0, 0),
    ("Onion", "ING-PRD-02", UnitOfMeasure.KG, "Produce", 22.0, 5.0, 0),
    ("French Fries (Frozen)", "ING-SID-01", UnitOfMeasure.KG, "Sides", 35.0, 8.0, 0),
]
