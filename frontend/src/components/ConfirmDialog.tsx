  ...
  return (
    <div className="fixed inset-0 z-[110] flex items-center justify-center bg-black/50 backdrop-blur-sm" onClick={handleCancel}>
      ...
      >
        ...
        <div className="px-6 py-4 bg-soot-50 border-t border-soot-200 flex justify-end gap-3">
          <button
            onClick={handleCancel}
            className="px-4 py-2 text-sm font-medium text-soot-700 bg-white border border-soot-300 rounded-lg hover:bg-soot-100 transition-colors"
          >
